...
public class HouseController {
	...
	@Autowired
	private HouseService haHouseService;
	
	@ApiOperation(value = "시도 정보", notes = "전국의 시도를 반환한다.", response = List.class)
	@GetMapping("/sido")
	public ResponseEntity<List<SidoGugunCode>> sido() throws Exception {
		logger.info("sido - 호출");
		return new ResponseEntity<List<SidoGugunCode>>(haHouseService.getSido(), HttpStatus.OK);
	}
	...
	public ResponseEntity<List<SidoGugunCode>> gugun(
		...
		return new ResponseEntity<List<SidoGugunCode>>(haHouseService.getGugunInSido(sido), HttpStatus.OK);
	}
	...
	public ResponseEntity<List<House>> dong(@RequestParam("gugun") String gugun) throws Exception {
		return new ResponseEntity<List<House>>(haHouseService.getDongInGugun(gugun), HttpStatus.OK);
	}
